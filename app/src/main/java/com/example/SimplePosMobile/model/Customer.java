...
public class Customer {
    ...
    public static final String CUSTOMER_JOINING_DATE ="joining_date";
    ...
    public static final String CREATE_TABLE_CUSTOMERS = "CREATE TABLE IF NOT EXISTS  "+TABLE_CUSTOMERS +"  (\n" +
            ...
            " "+CUSTOMER_PIN+" varchar(200),\n" +
            " "+CUSTOMER_LABEL+" varchar(200) , \n" +
            " "+CUSTOMER_TIN+" varchar(200), \n" +
            " "+CUSTOMER_JOINING_DATE+"  varchar(20)\n" +
            ");";
    ...
    public Customer(int customer_id, String customer_first_name, String customer_second_name, String customer_contact, String customer_address_one, String customer_address_two, String city, String state, String pin, String email, String label, String tin, String joining_date) {
